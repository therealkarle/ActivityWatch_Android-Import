...
8. Run `python google_drive_to_activitywatch.py`.
...
```powershell
python google_drive_to_activitywatch.py
```
...
1. Create a `.bat` file that runs `python "C:\path\to\google_drive_to_activitywatch.py"`.

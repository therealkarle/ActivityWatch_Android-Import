...
class ConfigTests(unittest.TestCase):
    def test_build_config_reads_afk_duplicate_bucket_ids(self) -> None:
        ...
        self.assertEqual(config.afk_duplicate_max_afk_gap_seconds, 900)
...
class AfkBucketTests(unittest.TestCase):
    ...
    def test_build_afk_duplicate_events_inserts_afk_gap(self) -> None:
        ...
        afk_events = aw.build_afk_duplicate_events(window_events, 120, 900)
    ...
    def test_build_afk_duplicate_events_uses_configurable_gap(self) -> None:
        ...
        afk_events = aw.build_afk_duplicate_events(window_events, 300, 900)
    ...
    def test_build_afk_duplicate_events_skips_large_afk_gaps(self) -> None:
        window_events = [
            {"timestamp": "2026-06-28T08:00:00Z", "duration": 0.0, "data": {}},
            {"timestamp": "2026-06-28T15:00:00Z", "duration": 0.0, "data": {}},
        ]
